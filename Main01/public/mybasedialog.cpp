...
MyBaseDialog::MyBaseDialog(QWidget *parent):QDialog(parent)
{
    ...
    closeBtn->setGeometry(QRect(this->width() - 55, 10, 45, 45));
    QIcon icon;
    ...
    minBtn->setGeometry(QRect(this->width() - 110, 10, 45, 45));
    QIcon icon1;
...
void MyBaseDialog::setTitleName(QString name)
{
    ...
    int lenName = name.length() * 40;
    qDebug() << "Width = " << lenName;
    title_label->setGeometry(QRect((this->width() - lenName) / 2, 5, lenName, 40));
